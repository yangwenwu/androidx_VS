package com.lemon.video.fragment.video.adapter;
...
public class NewVideoRecycleAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public List<HomeNewsBean> mData;
    protected Context context;
    protected OnItemClickListener onItemClickListener;

    public NewVideoRecycleAdapter2(Context context, List<HomeNewsBean> mData) {
        this.mData = mData;
