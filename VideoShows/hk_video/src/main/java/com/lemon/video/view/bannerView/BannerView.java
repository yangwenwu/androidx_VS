package com.lemon.video.view.bannerView;
...
//        vBottomBar.setBackgroundColor(barColor);
        vBottomBar.setBackgroundResource(R.drawable.banner_shape);
...
//        vBottomBar.setGravity(Gravity.CENTER);
        ...
        //根据路径得到Typeface
        Typeface tf=Typeface.createFromAsset(mgr, "fonts/Raleway_Bold.ttf");
        vTitleBar.setTypeface(tf);
//        vTitleBar.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT));
        vTitleBar.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT));
