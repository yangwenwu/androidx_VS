...
public class SearchVideoRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchVideoRecycleAdapter(Context context, List<HomeNewsBean> mData) {
        this.mData = mData;
...
//        view = LayoutInflater.from(context).inflate(R.layout.video_search_collection_item, parent, false);
