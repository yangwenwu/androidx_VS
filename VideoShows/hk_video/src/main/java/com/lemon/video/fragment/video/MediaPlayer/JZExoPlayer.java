package com.lemon.video.fragment.video.MediaPlayer;
...
public class JZExoPlayer extends JZMediaInterface implements Player.EventListener, VideoListener {
    ...
    public void prepare() {
        ...
        DataSource.Factory dataSourceFactory = new CacheDataSourceFactory(cache, new OkHttpDataSourceFactory(OkGo.getInstance().getOkHttpClient(), BaseApp.getUserAgent(), null, new CacheControl.Builder().minFresh(7, TimeUnit.DAYS).build()));
